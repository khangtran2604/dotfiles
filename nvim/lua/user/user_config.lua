...
M.plugins = {
	...
	{ import = "user.plugin-configs.oil", enabled = M.enable_plugins.oil },
	{ import = "user.plugin-configs.flash", enabled = M.enable_plugins.flash },
	{ import = "user.plugin-configs.harpoon", enabled = M.enable_plugins.harpoon },
	{ import = "user.plugin-configs.illuminate", enabled = M.enable_plugins.illuminate },
	{ import = "user.plugin-configs.todo-comments", enabled = M.enable_plugins.todo_comments },
	{ import = "user.plugin-configs.spectre", enabled = M.enable_plugins.spectre },
}
